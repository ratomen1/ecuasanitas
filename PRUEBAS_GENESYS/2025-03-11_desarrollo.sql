SELECT
           ...
           (CASE WHEN c.numero IS NOT NULL
                    ...
                    END
                                   ...
                                   d.titularfamilia_id ,
                                   cn.tipoPlan,
                                   (SELECT obtener_edad(e.fechanacimiento, '2025-03-01')) AS edad,
                                   ...
                                   (SELECT afiliacion_id
                                           ...
                                           WHERE
                                           '2025-03-01' BETWEEN fechainiciocobertura AND fechafincobertura
                                    ...
                                    (SELECT nombresupervisor FROM datos_supervisor_desde_comision('2025-03-01',ac.id)) END AS supervisor,
                                    cn.plan,
                                    cn.nivel,
                                    c.codigotarifario,
                                    c.fechainicio,
                                  ...
                                  eap.nombre AS aprobador,
                                   case when (select se_paga_comision_por_reingreso(
                                                   ...
                                                   a.fechaInicio,
                                                   c.numero)
                                    ) then 'SI' else 'NO' end as reingreso,
                            ...
                            FROM
                                    ...
                                    LEFT JOIN (SELECT * FROM calculo_reingreso('2025-03-01'))
                                    ...
                                    LEFT JOIN
                            	       LATERAL (SELECT fechapago,contratoid,fechaproduccion,numerosolicitud
                            			...
                            			AND fechaproduccion = '2025-03-01'
                                    ...
                                    AND rpc.fechaproduccion = '2025-03-01'
                            ...
                            WHERE
                                    o.fechapagocomision = '2025-03-01'
                                    AND d.codigogrupo <> 'IMP'

--4164 rows
select * from contratonivel



SELECT sepagacomisionporreingreso(
               'VN',          -- p_codigoservicio
               5,             -- p_aniosantiguedad
               5,             -- p_diasimpago
               '2025-02-01',  -- p_fechaexclusionantiguedadreingreso
               '2025-02-01'   -- p_fechainicionuevaafiliacion
       ) AS tienereingreso;

select se_paga_comision_por_reingreso(
               'VN',          -- p_codigoservicio
               5,             -- p_aniosantiguedad
               5,             -- p_diasimpago
               '2025-02-01',  -- p_fechaexclusionantiguedadreingreso
               '2025-02-01',  -- p_fechainicionuevaafiliacion
               607634         -- p_numerocontrato
       ) AS tienereingreso;